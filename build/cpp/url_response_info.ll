; ModuleID = 'cpp/url_response_info.cc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-f32:32:32-f64:32:64-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

%struct.PPB_URLResponseInfo_1_0 = type { i32 (i32)*, void (%struct.PP_Var*, i32, i32)*, i32 (i32)* }
...
@_ZZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs = internal global %struct.PPB_URLResponseInfo_1_0* null, align 4
@_ZGVZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs = internal global i64 0
@.str = private unnamed_addr constant [24 x i8] c"PPB_URLResponseInfo;1.0\00", align 1
...
@_ZN2pp15URLResponseInfoC1ERKS0_ = alias void (%"class.pp::URLResponseInfo"*, %"class.pp::URLResponseInfo"*)* @_ZN2pp15URLResponseInfoC2ERKS0_
@_ZN2pp15URLResponseInfoC1ENS_7PassRefEi = alias void (%"class.pp::URLResponseInfo"*, i32, i32)* @_ZN2pp15URLResponseInfoC2ENS_7PassRefEi

define void @_ZN2pp15URLResponseInfoC2ERKS0_(%"class.pp::URLResponseInfo"* %this, %"class.pp::URLResponseInfo"* %other) unnamed_addr align 2 {
  %1 = alloca %"class.pp::URLResponseInfo"*, align 4
  %2 = alloca %"class.pp::URLResponseInfo"*, align 4
  store %"class.pp::URLResponseInfo"* %this, %"class.pp::URLResponseInfo"** %1, align 4
  store %"class.pp::URLResponseInfo"* %other, %"class.pp::URLResponseInfo"** %2, align 4
  %3 = load %"class.pp::URLResponseInfo"** %1
  %4 = bitcast %"class.pp::URLResponseInfo"* %3 to %"class.pp::Resource"*
  %5 = load %"class.pp::URLResponseInfo"** %2
  %6 = bitcast %"class.pp::URLResponseInfo"* %5 to %"class.pp::Resource"*
  call void @_ZN2pp8ResourceC2ERKS0_(%"class.pp::Resource"* %4, %"class.pp::Resource"* %6)
  %7 = bitcast %"class.pp::URLResponseInfo"* %3 to i8***
  store i8** getelementptr inbounds ([4 x i8*]* @_ZTVN2pp15URLResponseInfoE, i64 0, i64 2), i8*** %7
  ret void
}

declare void @_ZN2pp8ResourceC2ERKS0_(%"class.pp::Resource"*, %"class.pp::Resource"*)

define void @_ZN2pp15URLResponseInfoC2ENS_7PassRefEi(%"class.pp::URLResponseInfo"* %this, i32, i32 %resource) unnamed_addr align 2 {
  %2 = alloca %"class.pp::URLResponseInfo"*, align 4
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  store %"class.pp::URLResponseInfo"* %this, %"class.pp::URLResponseInfo"** %2, align 4
  ...
  %8 = bitcast %"class.pp::URLResponseInfo"* %5 to i8***
  store i8** getelementptr inbounds ([4 x i8*]* @_ZTVN2pp15URLResponseInfoE, i64 0, i64 2), i8*** %8
  ret void
}

declare void @_ZN2pp8ResourceC2ENS_7PassRefEi(%"class.pp::Resource"*, i32, i32)

define void @_ZNK2pp15URLResponseInfo11GetPropertyE22PP_URLResponseProperty(%"class.pp::Var"* noalias sret %agg.result, %"class.pp::URLResponseInfo"* %this, i32 %property) align 2 {
  %1 = alloca %"class.pp::URLResponseInfo"*, align 4
  %2 = alloca i32, align 4
  %3 = alloca %struct.PP_Var, align 4
  store %"class.pp::URLResponseInfo"* %this, %"class.pp::URLResponseInfo"** %1, align 4
  store i32 %property, i32* %2, align 4
  %4 = load %"class.pp::URLResponseInfo"** %1
  %5 = call zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI23PPB_URLResponseInfo_1_0EEbv()
...
; <label>:7                                       ; preds = %0
  %8 = call %struct.PPB_URLResponseInfo_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_v()
  %9 = getelementptr inbounds %struct.PPB_URLResponseInfo_1_0* %8, i32 0, i32 1
  %10 = load void (%struct.PP_Var*, i32, i32)** %9, align 4
  %11 = bitcast %"class.pp::URLResponseInfo"* %4 to %"class.pp::Resource"*
...
define internal zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI23PPB_URLResponseInfo_1_0EEbv() inlinehint {
  %1 = call %struct.PPB_URLResponseInfo_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_v()
  %2 = icmp ne %struct.PPB_URLResponseInfo_1_0* %1, null
  ret i1 %2
}
...
define internal %struct.PPB_URLResponseInfo_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_v() inlinehint {
  %1 = alloca i8*
  %2 = alloca i32
  %3 = load atomic i8* bitcast (i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs to i8*) acquire, align 1
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %5, label %16

; <label>:5                                       ; preds = %0
  %6 = call i32 @__cxa_guard_acquire(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs)
  %7 = icmp ne i32 %6, 0
...
; <label>:10                                      ; preds = %8
  %11 = invoke i8* @_ZN2pp12_GLOBAL__N_114interface_nameI23PPB_URLResponseInfo_1_0EEPKcv()
...
; <label>:14                                      ; preds = %12
  %15 = bitcast i8* %13 to %struct.PPB_URLResponseInfo_1_0*
  store %struct.PPB_URLResponseInfo_1_0* %15, %struct.PPB_URLResponseInfo_1_0** @_ZZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs, align 4
  call void @__cxa_guard_release(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs)
  br label %16

; <label>:16                                      ; preds = %14, %5, %0
  %17 = load %struct.PPB_URLResponseInfo_1_0** @_ZZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs, align 4
  ret %struct.PPB_URLResponseInfo_1_0* %17
...
; <label>:18                                      ; preds = %12, %10, %8
  ...
  store i32 %21, i32* %2
  call void @__cxa_guard_abort(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_vE5funcs) nounwind
  br label %22
...
define void @_ZNK2pp15URLResponseInfo16GetBodyAsFileRefEv(%"class.pp::FileRef"* noalias sret %agg.result, %"class.pp::URLResponseInfo"* %this) align 2 {
  %1 = alloca %"class.pp::URLResponseInfo"*, align 4
  store %"class.pp::URLResponseInfo"* %this, %"class.pp::URLResponseInfo"** %1, align 4
  %2 = load %"class.pp::URLResponseInfo"** %1
  %3 = call zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI23PPB_URLResponseInfo_1_0EEbv()
...
; <label>:5                                       ; preds = %0
  %6 = call %struct.PPB_URLResponseInfo_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI23PPB_URLResponseInfo_1_0EEPKT_v()
  %7 = getelementptr inbounds %struct.PPB_URLResponseInfo_1_0* %6, i32 0, i32 2
  %8 = load i32 (i32)** %7, align 4
  %9 = bitcast %"class.pp::URLResponseInfo"* %2 to %"class.pp::Resource"*
...
declare void @_ZN2pp7FileRefC1ENS_7PassRefEi(%"class.pp::FileRef"*, i32, i32)
...
define internal i8* @_ZN2pp12_GLOBAL__N_114interface_nameI23PPB_URLResponseInfo_1_0EEPKcv() nounwind {
