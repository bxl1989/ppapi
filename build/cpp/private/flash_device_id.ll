; ModuleID = 'cpp/private/flash_device_id.cc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:32:64-f32:32:32-f64:32:64-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S128"
target triple = "i386-pc-linux-gnu"

%struct.PPB_Flash_DeviceID_1_0 = type { i32 (i32)*, i32 (i32, %struct.PP_Var*, %struct.PP_CompletionCallback*)* }
%struct.PP_Var = type { i32, i32, %union.PP_VarValue }
%union.PP_VarValue = type { double }
%struct.PP_CompletionCallback = type { void (i8*, i32)*, i8*, i32 }
%"class.pp::flash::DeviceID" = type { %"class.pp::Resource" }
...
@_ZTVN2pp5flash8DeviceIDE = linkonce_odr unnamed_addr constant [4 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTIN2pp5flash8DeviceIDE to i8*), i8* bitcast (void (%"class.pp::flash::DeviceID"*)* @_ZN2pp5flash8DeviceIDD1Ev to i8*), i8* bitcast (void (%"class.pp::flash::DeviceID"*)* @_ZN2pp5flash8DeviceIDD0Ev to i8*)]
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTSN2pp5flash8DeviceIDE = linkonce_odr constant [21 x i8] c"N2pp5flash8DeviceIDE\00"
@_ZTIN2pp8ResourceE = external constant i8*
@_ZTIN2pp5flash8DeviceIDE = linkonce_odr unnamed_addr constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i32 2) to i8*), i8* getelementptr inbounds ([21 x i8]* @_ZTSN2pp5flash8DeviceIDE, i32 0, i32 0), i8* bitcast (i8** @_ZTIN2pp8ResourceE to i8*) }
@_ZZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs = internal global %struct.PPB_Flash_DeviceID_1_0* null, align 4
@_ZGVZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs = internal global i64 0
@.str = private unnamed_addr constant [23 x i8] c"PPB_Flash_DeviceID;1.0\00", align 1

@_ZN2pp5flash8DeviceIDC1Ev = alias void (%"class.pp::flash::DeviceID"*)* @_ZN2pp5flash8DeviceIDC2Ev
@_ZN2pp5flash8DeviceIDC1ERKNS_14InstanceHandleE = alias void (%"class.pp::flash::DeviceID"*, %"class.pp::InstanceHandle"*)* @_ZN2pp5flash8DeviceIDC2ERKNS_14InstanceHandleE

define void @_ZN2pp5flash8DeviceIDC2Ev(%"class.pp::flash::DeviceID"* %this) unnamed_addr align 2 {
  %1 = alloca %"class.pp::flash::DeviceID"*, align 4
  store %"class.pp::flash::DeviceID"* %this, %"class.pp::flash::DeviceID"** %1, align 4
  %2 = load %"class.pp::flash::DeviceID"** %1
  %3 = bitcast %"class.pp::flash::DeviceID"* %2 to %"class.pp::Resource"*
  call void @_ZN2pp8ResourceC2Ev(%"class.pp::Resource"* %3)
  %4 = bitcast %"class.pp::flash::DeviceID"* %2 to i8***
  store i8** getelementptr inbounds ([4 x i8*]* @_ZTVN2pp5flash8DeviceIDE, i64 0, i64 2), i8*** %4
  ret void
}

declare void @_ZN2pp8ResourceC2Ev(%"class.pp::Resource"*)

define void @_ZN2pp5flash8DeviceIDC2ERKNS_14InstanceHandleE(%"class.pp::flash::DeviceID"* %this, %"class.pp::InstanceHandle"* %instance) unnamed_addr align 2 {
  %1 = alloca %"class.pp::flash::DeviceID"*, align 4
  ...
  %5 = load %"class.pp::flash::DeviceID"** %1
  %6 = bitcast %"class.pp::flash::DeviceID"* %5 to %"class.pp::Resource"*
  call void @_ZN2pp8ResourceC2Ev(%"class.pp::Resource"* %6)
  %7 = bitcast %"class.pp::flash::DeviceID"* %5 to i8***
  store i8** getelementptr inbounds ([4 x i8*]* @_ZTVN2pp5flash8DeviceIDE, i64 0, i64 2), i8*** %7
  %8 = invoke zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI22PPB_Flash_DeviceID_1_0EEbv()
...
; <label>:10                                      ; preds = %9
  %11 = bitcast %"class.pp::flash::DeviceID"* %5 to %"class.pp::Resource"*
  %12 = invoke %struct.PPB_Flash_DeviceID_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_v()
          to label %13 unwind label %22

; <label>:13                                      ; preds = %10
  %14 = getelementptr inbounds %struct.PPB_Flash_DeviceID_1_0* %12, i32 0, i32 0
...
; <label>:22                                      ; preds = %20, %18, %13, %10, %0
  ...
  store i32 %25, i32* %4
  %26 = bitcast %"class.pp::flash::DeviceID"* %5 to %"class.pp::Resource"*
...
define internal zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI22PPB_Flash_DeviceID_1_0EEbv() inlinehint {
  %1 = call %struct.PPB_Flash_DeviceID_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_v()
  %2 = icmp ne %struct.PPB_Flash_DeviceID_1_0* %1, null
  ret i1 %2
}
...
define internal %struct.PPB_Flash_DeviceID_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_v() inlinehint {
  %1 = alloca i8*
  %2 = alloca i32
  %3 = load atomic i8* bitcast (i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs to i8*) acquire, align 1
  %4 = icmp eq i8 %3, 0
  br i1 %4, label %5, label %16

; <label>:5                                       ; preds = %0
  %6 = call i32 @__cxa_guard_acquire(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs)
  %7 = icmp ne i32 %6, 0
...
; <label>:10                                      ; preds = %8
  %11 = invoke i8* @_ZN2pp12_GLOBAL__N_114interface_nameI22PPB_Flash_DeviceID_1_0EEPKcv()
...
; <label>:14                                      ; preds = %12
  %15 = bitcast i8* %13 to %struct.PPB_Flash_DeviceID_1_0*
  store %struct.PPB_Flash_DeviceID_1_0* %15, %struct.PPB_Flash_DeviceID_1_0** @_ZZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs, align 4
  call void @__cxa_guard_release(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs)
  br label %16

; <label>:16                                      ; preds = %14, %5, %0
  %17 = load %struct.PPB_Flash_DeviceID_1_0** @_ZZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs, align 4
  ret %struct.PPB_Flash_DeviceID_1_0* %17
...
; <label>:18                                      ; preds = %12, %10, %8
  ...
  store i32 %21, i32* %2
  call void @__cxa_guard_abort(i64* @_ZGVZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_vE5funcs) nounwind
  br label %22
...
define i32 @_ZN2pp5flash8DeviceID11GetDeviceIDERKNS_28CompletionCallbackWithOutputINS_3VarEEE(%"class.pp::flash::DeviceID"* %this, %"class.pp::CompletionCallbackWithOutput"* %callback) align 2 {
  %1 = alloca i32, align 4
  %2 = alloca %"class.pp::flash::DeviceID"*, align 4
  %3 = alloca %"class.pp::CompletionCallbackWithOutput"*, align 4
  %4 = alloca %struct.PP_CompletionCallback, align 4
  store %"class.pp::flash::DeviceID"* %this, %"class.pp::flash::DeviceID"** %2, align 4
  store %"class.pp::CompletionCallbackWithOutput"* %callback, %"class.pp::CompletionCallbackWithOutput"** %3, align 4
  %5 = load %"class.pp::flash::DeviceID"** %2
  %6 = call zeroext i1 @_ZN2pp12_GLOBAL__N_113has_interfaceI22PPB_Flash_DeviceID_1_0EEbv()
  br i1 %6, label %7, label %21

; <label>:7                                       ; preds = %0
  %8 = call %struct.PPB_Flash_DeviceID_1_0* @_ZN2pp12_GLOBAL__N_113get_interfaceI22PPB_Flash_DeviceID_1_0EEPKT_v()
  %9 = getelementptr inbounds %struct.PPB_Flash_DeviceID_1_0* %8, i32 0, i32 1
  %10 = load i32 (i32, %struct.PP_Var*, %struct.PP_CompletionCallback*)** %9, align 4
  %11 = bitcast %"class.pp::flash::DeviceID"* %5 to %"class.pp::Resource"*
  %12 = call i32 @_ZNK2pp8Resource11pp_resourceEv(%"class.pp::Resource"* %11)
  %13 = load %"class.pp::CompletionCallbackWithOutput"** %3
  %14 = call %struct.PP_Var* @_ZNK2pp28CompletionCallbackWithOutputINS_3VarEE6outputEv(%"class.pp::CompletionCallbackWithOutput"* %13)
  ...
  %20 = call i32 %10(i32 %12, %struct.PP_Var* %14, %struct.PP_CompletionCallback* byval align 4 %4)
  store i32 %20, i32* %1
  br label %25
...
; <label>:21                                      ; preds = %0
  ...
  %24 = call i32 @_ZNK2pp18CompletionCallback8MayForceEi(%"class.pp::CompletionCallback"* %23, i32 -6)
  store i32 %24, i32* %1
  br label %25
...
define linkonce_odr %struct.PP_Var* @_ZNK2pp28CompletionCallbackWithOutputINS_3VarEE6outputEv(%"class.pp::CompletionCallbackWithOutput"* %this) align 2 {
  ...
  %5 = call %struct.PP_Var* @_ZN2pp8internal20CallbackOutputTraitsINS_3VarEE15StorageToAPIArgER6PP_Var(%struct.PP_Var* %4)
  ret %struct.PP_Var* %5
}
...
define linkonce_odr void @_ZN2pp5flash8DeviceIDD1Ev(%"class.pp::flash::DeviceID"* %this) unnamed_addr inlinehint align 2 {
  %1 = alloca %"class.pp::flash::DeviceID"*, align 4
  store %"class.pp::flash::DeviceID"* %this, %"class.pp::flash::DeviceID"** %1, align 4
  %2 = load %"class.pp::flash::DeviceID"** %1
  call void @_ZN2pp5flash8DeviceIDD2Ev(%"class.pp::flash::DeviceID"* %2)
  ret void
}

define linkonce_odr void @_ZN2pp5flash8DeviceIDD0Ev(%"class.pp::flash::DeviceID"* %this) unnamed_addr inlinehint align 2 {
  %1 = alloca %"class.pp::flash::DeviceID"*, align 4
  %2 = alloca i8*
  %3 = alloca i32
  store %"class.pp::flash::DeviceID"* %this, %"class.pp::flash::DeviceID"** %1, align 4
  %4 = load %"class.pp::flash::DeviceID"** %1
  invoke void @_ZN2pp5flash8DeviceIDD1Ev(%"class.pp::flash::DeviceID"* %4)
          to label %5 unwind label %7

; <label>:5                                       ; preds = %0
  %6 = bitcast %"class.pp::flash::DeviceID"* %4 to i8*
...
; <label>:7                                       ; preds = %0
  ...
  store i32 %10, i32* %3
  %11 = bitcast %"class.pp::flash::DeviceID"* %4 to i8*
...
define linkonce_odr void @_ZN2pp5flash8DeviceIDD2Ev(%"class.pp::flash::DeviceID"* %this) unnamed_addr inlinehint align 2 {
  %1 = alloca %"class.pp::flash::DeviceID"*, align 4
  store %"class.pp::flash::DeviceID"* %this, %"class.pp::flash::DeviceID"** %1, align 4
  %2 = load %"class.pp::flash::DeviceID"** %1
  %3 = bitcast %"class.pp::flash::DeviceID"* %2 to %"class.pp::Resource"*
...
define linkonce_odr %struct.PP_Var* @_ZN2pp8internal20CallbackOutputTraitsINS_3VarEE15StorageToAPIArgER6PP_Var(%struct.PP_Var* %t) nounwind inlinehint align 2 {
  %1 = alloca %struct.PP_Var*, align 4
  store %struct.PP_Var* %t, %struct.PP_Var** %1, align 4
...
define internal i8* @_ZN2pp12_GLOBAL__N_114interface_nameI22PPB_Flash_DeviceID_1_0EEPKcv() nounwind {
